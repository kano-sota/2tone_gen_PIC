...
void sine_table_gen(void);

uint8_t sine_table[500] = {};
...
void Timer_init(void) {
    ...
    PEIE = 1;
    GIE = 1;
    PR2 = (uint8_t)((uint32_t)32000000/((uint32_t)50000 * 4) - 1);
    T2CON = 0b10000000;
...
void sine_table_gen(void) {
    for (uint16_t i=0; i < 500; i++) {
        *(sine_table + i) = (uint8_t)((float)127 * sinf(6.28 * (float)i / 256)) + 128;
    }
}
